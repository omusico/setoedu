...
if(isset($_POST["submit"])) {
	$news_query = mysql_query("Delete from newsupdates where news_id=$id") or die(mysql_error());
		...
		<section id="content">
			<div class="marg_top wrapper">
				<article class="col2 pad_left1">
					...
					?>
							<input onclick="window.confirm('Are you sure, you want to delete news?')" class="button green" name="submit" type="submit" value="Delete"></input>
					</fieldset>
					</form>
					<br/>
