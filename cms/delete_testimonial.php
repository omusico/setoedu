...
if(isset($_POST["submit"])) {
	$testimonial_query = mysql_query("Delete from testimonials where user_id=$id") or die(mysql_error());
	$t_data = mysql_fetch_object($t_query);
	$filename = '../'.$t_data->photo_path;
	unlink($filename);
			...
			<div class="marg_top wrapper">
				<article class="col2 pad_left1">
					...
					<?php $t_data = mysql_fetch_object($t_query); 
						...
						?>
						<input onclick="window.confirm('Are you sure, you want to delete testimonial?')" class="button green" name="submit" type="submit" value="Delete"></input>
					</fieldset>
					</form>
					<br/>
