		...
		<section id="content">
			<div class="marg_top wrapper">
				<article class="col2 pad_left1">
					...
					<div style="display:block"><a href="create_event.php">Create</a></div><br/>
					<table>
						<tr>
						...
						<?php foreach( $eventList as $eventItem ){
							...
							echo '<tr>
									...
									<td><a href="edit_event.php?title='.$eventItem['title'].'">Edit</a> | <a href="view_event.php?title='.$eventItem['title'].'">Detail</a> | <a href="delete_event.php?title='.$eventItem['title'].'">Delete</a></td>
								</tr>';
							} ?>
						</table>
