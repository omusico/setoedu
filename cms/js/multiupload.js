			...
			var uId = "";
 			for(var i = 0; i<this.items.length; i++){
				...
				if(typeof this.items[i] != undefined){
					...
					html += '<div class="dfiles'+errorClass+'" rel="'+uId+'"><h2 id="up">'+sampleIcon+this.items[i].name+'</h2><div id="'+uId+'" class="progress" style="display:none;"><img src="images/ajax-loader.gif" /></div></div>';
				}
			}
