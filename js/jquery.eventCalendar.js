					...
					if (limit === 0 || limit > i) {
						...
						if ((month === false || month == eventMonth) 
								...
								if (month === false && eventDate < new Date()) {
									...
									events.push('<li id="' + key + '" class="'+event.type+'"><time datetime="'+eventDate+'"><em>' + eventStringDate + '</em></time> <p class="eventTitle">' + event.title + '</p><p class="eventDesc ' + eventDescClass + '"><b>' + event.description + '</b></p></li>');
									i++;
								}
						}
					}
